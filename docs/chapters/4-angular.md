...
Interact with and rotate these exact mathematical shapes: **[3D Atomic Orbital Visualizer](https://www.desmos.com/3d/qhbfggpwst)**.
...
The following diagrams, extracted from the Quantum Principles reference sheet, show the visual form of each orbital type along with its orientation count and capacity.
